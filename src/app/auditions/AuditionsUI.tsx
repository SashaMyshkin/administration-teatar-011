  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      renderCell: (params: GridRenderCellParams<any, String>) => {
        switch (params.value) {
          case 'in-progress':
            return(<span style={{color:theme.palette.primary.main}}><b>Aktivna</b></span>)
            break;
          case 'draft':
            return(<span style={{color:theme.palette.secondary.main}}><b>Nacrt</b></span>)
            break;
          case 'finished':
            return(<span style={{color:theme.palette.success.main}}><b>Završena</b></span>)
            break;
          default:
            return(<span style={{color:theme.palette.error.main}}><b>Unknown</b></span>)
            break;
        }
